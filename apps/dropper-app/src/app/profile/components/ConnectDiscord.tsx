...
export default function ConnectDiscord({ discordAccount }: Props) {
  ...
  return (
    <div className="flex flex-col w-full gap-4">
      ...
      {!discordAccount && (
        <a
          href="https://discord.com/oauth2/authorize?client_id=1218366674449989735&response_type=code&redirect_uri=https%3A%2F%2Fdropper.wtf%2Fauth%2Fcallback%2Fdiscord&scope=identify"
          className=""
        >
